...
class MinioStorageProvider(StorageProvider):
    def __init__(self, endpoint: str, access_key: str, secret_key: str, bucket_name: str, secure: bool = False):
        try:
            ...
            raise ImportError(
                "The 'minio' library is required for MinioStorageProvider. Install it with 'pip install minio'."
            )
    ...
    def save_file(self, content: bytes, filename: str) -> str:
        ...
        self.client.put_object(self.bucket_name, filename, data, length=len(content))
    ...
    def get_file_url(self, filename: str) -> str:
        ...
        return self.client.get_presigned_url("GET", self.bucket_name, filename)
